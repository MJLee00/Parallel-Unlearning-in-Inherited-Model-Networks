...
def train_task_for_data(cfg, **kwargs):
    ...
    # ##创建经过筛选后的数据加载器
    tmp_path = '/home/zjy/lmy/UnlearningDiffusion/test/param_data/tmp_2024-12-08_11-17-09'
    his_path = tmp_path + '/'
    ...
    clients[0].test(cfg,r1, clients[0].criterion, clients[0].testloader)
    clients[0].test(cfg,r1, clients[0].criterion, clients[0].test_loader_sense)
    ...
    ssd_reverse_tuning(cfg, clients[0], r1, clients[0].test_loader_sense, clients[0].testloader, next(clients[0].net.parameters()).device, clients[0].train_layer, classes_to_remove)
