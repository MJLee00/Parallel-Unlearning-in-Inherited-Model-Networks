...
def train_task_for_data(cfg, **kwargs):
    ...
    # ##创建经过筛选后的数据加载器
    tmp_path = '/home/zjy/lmy/UnlearningDiffusion/test/param_data_his/cifar100-resnet-multi0%_fed'
    his_path = tmp_path + '/'
    ...
    ssd_graph_tuning(cfg,[r1],[clients[1]], [r2,r3,r4], [clients[1],clients[2],clients[2]],  next(clients[1].net.parameters()).device, clients[1].train_layer, classes_to_remove)
